...
| [`04-REFATORACAO-SEGURA-DOS-MONOLITOS.md`](./04-REFATORACAO-SEGURA-DOS-MONOLITOS.md) | Decomposição em camadas de `bm_mockup_video.py` e `pipeline.py` | Médio | Manutenibilidade sem quebrar interface de linha de comando |
