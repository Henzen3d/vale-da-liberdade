...
#
# Hermes mata no_agent no cron.script_timeout_seconds (default 3600s).
...
# Este arquivo é a fonte canônica. Copiar para ~/.hermes/scripts/ após editar.
# ==============================================================================
...
# 3300s = 55 min. Folga antes do kill do Hermes (hourly self-caps mesmo se o daily for 7200s).
BUDGET_S=3300
MOCKUP_MIN_S=900
