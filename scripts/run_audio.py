#!/usr/bin/env python3
"""Emergency: audio/TTS stage only for the daily episode.

Usage:
  python3 scripts/run_audio.py
  python3 scripts/run_audio.py --date 2026-08-04
"""
...
def main() -> int:
    ...
    cmd = [str(PY), str(SCRIPTS / "pipeline.py"), "audio", "--date", args.date]
    print(f"▶ {' '.join(cmd)}")
